...
package com.juzifenqi.app.other;
...
public class SystemBarTintManager {
     ...
     */
    @TargetApi(19)
    public SystemBarTintManager(Activity activity, Dialog dialog) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                ...
                TypedArray arrayType = null;
                try {
                    arrayType = activity.obtainStyledAttributes(attrs);
                    mStatusBarAvailable = arrayType.getBoolean(activity.getResources().getInteger(R.integer.zero), false);
                    mNavBarAvailable = arrayType.getBoolean(activity.getResources().getInteger(R.integer.one), false);
                } catch (Exception e) {
    ...
    public void setStatusBarTintEnabled(boolean enabled) {
        ...
        if (mStatusBarAvailable && mStatusBarTintView != null) {
    ...
    public static class SystemBarConfig {
         ...
         * screen.
         *
         * @param withActionBar True to include the height of the action bar, False
         *                      otherwise.
