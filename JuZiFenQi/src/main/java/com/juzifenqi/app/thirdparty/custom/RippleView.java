package com.juzifenqi.app.thirdparty.views.custom;
...
public class RippleView extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, ContextCompat.getColor(getContext(), R.color.white));
